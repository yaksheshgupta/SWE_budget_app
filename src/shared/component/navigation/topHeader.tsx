	...
	return (
		<div className='flex width--full justify__content--between mt--30 align__items--center header-wrapper'>
			...
			<img
				...
				alt='Olivia Davis'
				title={'Olivia Davis'}
				className='width--75-px mr--40 d-block header__wrapper--profile-image header__wrapper--profile-image'
			/>

			<div className='align__items--center user-profile--wrapper d-none'>
				<img src={friendImageOne} alt='Olivia Davis' className='width--50-px mr--10' />
